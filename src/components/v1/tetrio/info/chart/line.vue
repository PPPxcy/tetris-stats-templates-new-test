...
onMounted(async () => {
	icon_image.value = await import(`~/assets/images/rank/${data.multiplayer.icon}.svg?url`)
		.then(module => {
...
<template>
	<template v-if="valid">
		<div class="relative">
			<div class="w-143.75 h-68.75 rounded-7.5"
				 style="background: linear-gradient(222deg, #525252 11.97%, #1D1916 89.73%);box-shadow: 0 0.9375rem 1.875rem 0 #0000004d;">
				<chart :option="option"/>
			</div>
