...
const valid = computed(() => {
	...
	return isNonNullish(data.multiplayer.app) && isNonNullish(data.multiplayer.ci) && isNonNullish(data.multiplayer.dspp) && isNonNullish(data.multiplayer.dsps) && isNonNullish(data.multiplayer.ge) && isNonNullish(data.multiplayer.pps)
})
</script>
