	...
	<template v-if="valid">
		...
		<div class="mt-2.75">
			<div class="flex gap-6.25">
				<div class="size-68.75 rounded-7.5 bg-[#fafafa]"
					...
					<div class="size-full px-6.25 py-10 box-border">
						<div class="flex flex-col gap-8.75 items-center">
							<div class="size-31.25">
								<svg fill="none" height="125" viewBox="0 0 125 125" width="125"
									...
									<g filter="url(#filter0_d_2242_235)">
										<rect fill="#A5F3FD" height="34.5394" rx="2"
											  transform="rotate(45 61.7178 10.1713)" width="34.5395"
											  x="61.7178" y="10.1713"/>
										<rect fill="#FEF18B" height="34.5394" rx="2"
											  transform="rotate(45 34.585 37.3075)" width="34.5395"
											  x="34.585" y="37.3075"/>
										<rect fill="#FEF18B" height="34.5394" rx="2"
											  transform="rotate(45 88.8516 37.3075)" width="34.5395"
											  x="88.8516" y="37.3075"/>
										<rect fill="#A5F3FD" height="34.5394" rx="2"
											  transform="rotate(45 61.7178 64.4452)" width="34.5395"
											  x="61.7178" y="64.4452"/>
									</g>
									<defs>
										<pattern id="pattern0_2242_235" height="1"
												 patternContentUnits="objectBoundingBox" width="1">
											<use transform="scale(0.00121359)" xlink:href="#image0_2242_235"/>
										</pattern>
										<filter id="filter0_d_2242_235" color-interpolation-filters="sRGB"
												filterUnits="userSpaceOnUse" height="109.463"
												width="109.456" x="6.99023"
												y="8.99963">
											...
											<feBlend in="SourceGraphic" in2="effect1_dropShadow_2242_235" mode="normal"
													 result="shape"/>
										</filter>
									</defs>
								</svg>
