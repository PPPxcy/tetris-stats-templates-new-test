				...
				<svg fill="none" height="125" viewBox="0 0 275 125" width="275" xmlns="http://www.w3.org/2000/svg">
					<g clip-path="url(#clip0_2242_273)">
						...
						<g opacity="0.5" style="mix-blend-mode:overlay">
							<mask id="mask0_2242_273" height="178" maskUnits="userSpaceOnUse" style="mask-type:alpha"
								  width="177"
								  x="147" y="-27">
								<rect fill="url(#paint1_radial_2242_273)" height="144.298"
									  transform="rotate(-15 147 11)" width="144.298" x="147"
									  y="11"/>
							</mask>
					...
					<defs>
						<linearGradient id="paint0_linear_2242_273" gradientUnits="userSpaceOnUse" x1="50.5" x2="244"
										y1="-12"
										y2="144.5">
