...
const valid = computed(() => {
	...
	return isNonNullish(data.multiplayer.adpm) && isNonNullish(data.multiplayer.vs) && isNonNullish(data.multiplayer.adpl)
})
</script>
				...
				<svg fill="none" height="125" viewBox="0 0 275 125" width="275" xmlns="http://www.w3.org/2000/svg">
					<g clip-path="url(#clip0_2242_615)">
						...
						<g opacity="0.5" style="mix-blend-mode:overlay">
							<mask id="mask0_2242_615" height="208" maskUnits="userSpaceOnUse" style="mask-type:alpha"
								  width="209"
								  x="92" y="-32">
								<rect fill="url(#paint1_radial_2242_615)" height="169.169"
									  transform="rotate(-15 92.9521 12.3839)" width="169.169"
									  x="92.9521" y="12.3839"/>
							</mask>
							<g mask="url(#mask0_2242_615)">
								<rect fill="black" height="42.2923" transform="rotate(-15 201.286 49.032)"
									  width="42.2923"
									  x="201.286" y="49.032"/>
								<rect fill="url(#paint2_linear_2242_615)" height="42.2923"
									  transform="rotate(-15 115.499 72.0188)" width="88.8138"
									  x="115.499" y="72.0188"/>
					...
					<defs>
						<linearGradient id="paint0_linear_2242_615" gradientUnits="userSpaceOnUse" x1="50.5" x2="244"
										y1="-12"
										y2="144.5">
						...
						<linearGradient id="paint2_linear_2242_615" gradientUnits="userSpaceOnUse" x1="115.499"
										x2="204.313" y1="72.0188"
										y2="72.0188">
							<stop stop-opacity="0"/>
