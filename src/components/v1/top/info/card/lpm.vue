...
const valid = computed(() => {
	...
	return isNonNullish(source.lpm) && isNonNullish(source.pps)
})
</script>
				...
				<svg fill="none" height="125" viewBox="0 0 275 125" width="275" xmlns="http://www.w3.org/2000/svg">
					<g clip-path="url(#clip0_2242_561)">
						...
						<g style="mix-blend-mode:overlay">
							<mask id="mask0_2242_561" height="154" maskUnits="userSpaceOnUse" style="mask-type:alpha"
								  width="154"
								  x="122" y="-15">
								<rect fill="url(#paint1_radial_2242_561)" height="125" transform="rotate(-15 122 18)"
									  width="125" x="122"
									  y="18"/>
							</mask>
							<g mask="url(#mask0_2242_561)">
								<path clip-rule="evenodd"
									  ...
									  fill="black"
									  fill-rule="evenodd"/>
								<rect fill="black" height="31.25" transform="rotate(-15 138.176 78.3704)"
									  width="45.3125"
									  x="138.176" y="78.3704"/>
								<rect fill="black" height="31.25" transform="rotate(-15 215.148 57.7457)"
									  width="45.3125"
									  x="215.148" y="57.7457"/>
								<rect fill="url(#paint2_linear_2242_561)" height="62.5"
									  transform="rotate(-15 167.277 5.8678)" width="31.25"
									  x="167.277" y="5.8678"/>
								<rect fill="black" height="31.25" transform="rotate(-15 198.547 62.1942)" width="15.625"
									  x="198.547" y="62.1942"/>
								<rect fill="black" height="31.25" transform="rotate(-15 179.41 51.1456)" width="15.625"
									  x="179.41" y="51.1456"/>
							</g>
						</g>
					</g>
					<defs>
						<linearGradient id="paint0_linear_2242_561" gradientUnits="userSpaceOnUse" x1="50.5" x2="244"
										y1="-12"
										y2="144.5">
						...
						<linearGradient id="paint2_linear_2242_561" gradientUnits="userSpaceOnUse" x1="182.902"
										x2="182.902"
										y1="5.8678"
										y2="68.3678">
							<stop stop-opacity="0"/>
